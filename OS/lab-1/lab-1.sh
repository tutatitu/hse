...
read -p "Введите количество создаваемых пользователей: " user_count

# Проверка наличия введенного количества пользователей
if [ -z "$user_count" ]; then
echo "Ошибка: Количество пользователей не может быть пустым."
exit 1
fi
